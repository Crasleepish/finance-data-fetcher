...
class IndexHistStockCleaner:
    """Normalize Tushare index_daily rows into index_hist records."""

    def clean(self, raw_batch: RawBatch) -> NormalizedBatch:
        """Normalize raw index_daily rows into DB-ready records."""
        ...
        for row in _list_of_dicts(raw_batch):
            ...
            record = {
                ...
                "volume": _as_int(_scale(row.get("vol"), 100)),
                "amount": _as_float(_scale(row.get("amount"), 1000)),
