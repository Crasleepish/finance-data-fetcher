...
class RtStockHistUnadjCleaner:
    """Clean and normalize real-time stock snapshot rows."""
    ...
    def __init__(self) -> None:
        ...
        self._cleaner = TypedCleaner(
            ...
            required_fields={"stock_code", "latest_time"},
            casts={
                "open": _to_float,
                "close": _to_float,
                "high": _to_float,
    ...
    def clean(self, raw_batch: RawBatch) -> NormalizedBatch:
        """Normalize raw snapshot rows into rt_stock_hist_unadj records."""
